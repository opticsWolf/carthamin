...
// Lexer: ClojureScriptLexer

use crate::token::Token;
use crate::lexer::{Lexer, RegexLexer, LexerRule, LexerAction};
use crate::scanner::TokenPattern;

/// Auto-generated ClojureScriptLexer lexer.
pub struct ClojureScriptLexer {
    inner: RegexLexer,
}

impl ClojureScriptLexer {
    pub fn new() -> Self {
        let mut inner = RegexLexer::new("ClojureScript");
        inner.aliases = vec![
            "clojurescript",
            "cljs",
        ];
        ...
        ClojureScriptLexer { inner }
    }
}

impl Lexer for ClojureScriptLexer {
