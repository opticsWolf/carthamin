...
/// Auto-generated OctaveLexer lexer.
...
impl OctaveLexer {
    pub fn new() -> Self {
        let mut inner = RegexLexer::new("Octave");
        inner.aliases = vec![
            "octave",
        ];
        inner.filenames = vec![
        ...
        let mut root_rules: Vec<LexerRule> = Vec::new();
            ...
            root_rules.push(LexerRule { pattern: TokenPattern::new(r"(\d+\.\d*|\d*\.\d+)([eEf][+-]?[0-9]+)?", Token::NUMBER_FLOAT).unwrap(), action: LexerAction::token(Token::NUMBER_FLOAT) });
            root_rules.push(LexerRule { pattern: TokenPattern::new(r"\d+[eEf][+-]?[0-9]+", Token::NUMBER_FLOAT).unwrap(), action: LexerAction::token(Token::NUMBER_FLOAT) });
            ...
            root_rules.push(LexerRule { pattern: TokenPattern::new(r"(?<![\w)\].])\'", Token::STRING).unwrap(), action: LexerAction::Push("string".to_string()) });
        ...
        // State: percentblockcomment
        inner.states.insert("percentblockcomment".to_string(), vec![
        ...
        // State: hashblockcomment
        inner.states.insert("hashblockcomment".to_string(), vec![
            LexerRule { pattern: TokenPattern::new(r"^\s*#\}", Token::COMMENT_MULTILINE).unwrap(), action: LexerAction::PopN(1) },
            LexerRule { pattern: TokenPattern::new(r"^.*\n", Token::COMMENT_MULTILINE).unwrap(), action: LexerAction::token(Token::COMMENT_MULTILINE) },
            LexerRule { pattern: TokenPattern::new(r".", Token::COMMENT_MULTILINE).unwrap(), action: LexerAction::token(Token::COMMENT_MULTILINE) },
        ]);
        ...
        // State: deffunc
        inner.states.insert("deffunc".to_string(), vec![
        ]);
