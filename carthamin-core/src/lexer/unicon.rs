...
/// Auto-generated UniconLexer lexer.
...
impl UniconLexer {
    pub fn new() -> Self {
        let mut inner = RegexLexer::new("Unicon");
        inner.aliases = vec![
            "unicon",
        ];
        inner.filenames = vec![
