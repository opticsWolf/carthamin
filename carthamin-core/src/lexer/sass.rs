...
/// Auto-generated SassLexer lexer.
...
impl SassLexer {
    pub fn new() -> Self {
        let mut inner = RegexLexer::new("Sass");
        inner.aliases = vec![
            "sass",
        ];
        inner.filenames = vec![
        ...
        inner.states.insert("content".to_string(), vec![
            LexerRule { pattern: TokenPattern::new(r"@import", Token::KEYWORD).unwrap(), action: LexerAction::Push("import".to_string()) },
            LexerRule { pattern: TokenPattern::new(r"@for", Token::KEYWORD).unwrap(), action: LexerAction::Push("for".to_string()) },
            LexerRule { pattern: TokenPattern::new(r"@(debug|warn|if|while)", Token::KEYWORD).unwrap(), action: LexerAction::Push("value".to_string()) },
            LexerRule { pattern: TokenPattern::new(r"@extend", Token::KEYWORD).unwrap(), action: LexerAction::Push("selector".to_string()) },
            LexerRule { pattern: TokenPattern::new(r"@[\w-]+", Token::KEYWORD).unwrap(), action: LexerAction::Push("selector".to_string()) },
            LexerRule { pattern: TokenPattern::new(r"=[\w-]+", Token::NAME_FUNCTION).unwrap(), action: LexerAction::Push("value".to_string()) },
            LexerRule { pattern: TokenPattern::new(r"\+[\w-]+", Token::NAME_DECORATOR).unwrap(), action: LexerAction::Push("value".to_string()) },
            LexerRule { pattern: TokenPattern::new(r":", Token::NAME_ATTRIBUTE).unwrap(), action: LexerAction::Push("old-style-attr".to_string()) },
            LexerRule { pattern: TokenPattern::new(r"(?=.+?[=:]([^a-z]|$))", Token::NAME_ATTRIBUTE).unwrap(), action: LexerAction::Push("new-style-attr".to_string()) },
        ]);

        // State: single-comment
        inner.states.insert("single-comment".to_string(), vec![
            LexerRule { pattern: TokenPattern::new(r".+", Token::COMMENT_SINGLE).unwrap(), action: LexerAction::token(Token::COMMENT_SINGLE) },
        ]);

        // State: multi-comment
        inner.states.insert("multi-comment".to_string(), vec![
        ...
        // State: old-style-attr
        inner.states.insert("old-style-attr".to_string(), vec![
        ...
        // State: new-style-attr
        inner.states.insert("new-style-attr".to_string(), vec![
            LexerRule { pattern: TokenPattern::new(r#"[^\s:="\[]+"#, Token::NAME_ATTRIBUTE).unwrap(), action: LexerAction::token(Token::NAME_ATTRIBUTE) },
            LexerRule { pattern: TokenPattern::new(r"#\{", Token::STRING_INTERPOL).unwrap(), action: LexerAction::Push("interpolation".to_string()) },
        ]);
