...
/// Auto-generated StanLexer lexer.
pub struct StanLexer {
    inner: RegexLexer,
}

impl StanLexer {
    pub fn new() -> Self {
        let mut inner = RegexLexer::new("Stan");
        inner.aliases = vec![
            "stan",
        ];
        inner.filenames = vec![
        ...
        let mut root_rules: Vec<LexerRule> = Vec::new();
            ...
            root_rules.push(LexerRule { pattern: TokenPattern::new(r"[A-Za-z]\w*\b", Token::NAME).unwrap(), action: LexerAction::token(Token::NAME) });
